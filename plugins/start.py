...
async def start_command(client: Client, message: Message):
    ...
    if id == owner_id:
        ...
        if "verify_" in message.text:
            ...
            SD = await message.reply_text(" Files will be deleted After 600 seconds. Save them to the Saved Message now!")
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                short_url = f"tnshort.net"
                TUT_VID = f"https://t.me/terao2"
